...
class FinetuneWrapper(BaseWrapper):
    ...
    def __init__(self, model, nclasses, exp_dict, select_entropy=False):
        ...
        # load clusters
        c_list, c_centers, ind_sorted = self.load_clusters(self.exp_dict['dataset_train'])
    ...
    def load_clusters(self, dataset):
        if 'miniimagenet' in dataset:
            root='../data/cfe_encodings/miniimagenet_128_K_500_train_clusters.npz'
            data_root="../data/cfe_encodings/miniimagenet_128_K_500_train.npz"
        elif 'omniglot' in dataset:
            root='../data/cfe_encodings/omniglot_64_K_500_train_clusters.npz'
            data_root = '../data/cfe_encodings/omniglot_64_K_500_train.npz'
        elif 'tiered-imagenet' in dataset:
            root='../data/cfe_encodings/tieredimagenet_128_K_500_train_clusters.npz'
            data_root = '../data/cfe_encodings/tieredimagenet_128_K_500_train.npz'
        np_load_old = np.load
