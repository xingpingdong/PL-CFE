...
from maml.metalearners.maml_pem import ModelAgnosticMetaLearning
...
def main(args):
    ...
    if args.dataset == 'omniglot':
        transform = Compose([ToPILImage(), Resize(28), ToTensor()])
        transform = None
        ...
        transform = Compose([ToPILImage(), Resize(84), ToTensor()])
        transform = None
