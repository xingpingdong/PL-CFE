#!/bin/bash
cd ..
out='./results/un_maml_pem/tiered'
python train_un_maml_pem.py ./data --dataset tieredimagenet --num-ways 5 --num-shots 1 \
      --num-shots-test 5 --num-epochs 200 --use-cuda --output-folder $out
